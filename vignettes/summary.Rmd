...
(http://docs.cartodb.com/cartodb-platform/sql-api/). This allows users to exploit the CartoDB's extensive PostGIS spatial database and web publishing services.   
