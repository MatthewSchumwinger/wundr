...
author: "J.A. Marin, Matthew Schumwinger, Stefan Zohren"
date: "`r Sys.Date()`"
...
Package **wundr** provides API interfaces to Personal Weather Station (PWS) data maintained by Weather Underground (wunderground.com). Tables of PWS
...
contextual static maps, interactive web maps, and animated plots. Facility
to export data to CartoDB's spatial database hosting and webmap publishing
platform.
...
## Subsettable tables based on #1
[John, we can add my new draw_subset method to your other work on this]
